...
enum vmm_region_flags {
	...
	VMM_REGION_PHYSALIAS=0x00000008,
	VMM_REGION_MEMORY=0x00000010,
	VMM_REGION_IO=0x00000020,
	VMM_REGION_CACHEABLE=0x00000040,
	VMM_REGION_BUFFERABLE=0x00000080,
	VMM_REGION_READONLY=0x00000100,
	VMM_REGION_ISHOSTRAM=0x00000200,
	VMM_REGION_ISRAM=0x00000400,
	VMM_REGION_ISROM=0x00000800,
	VMM_REGION_ISDEVICE=0x00001000,
	VMM_REGION_ISRESERVED=0x00002000,
	VMM_REGION_ISALLOCED=0x00004000,
};

#define VMM_REGION_MANIFEST_MASK	(VMM_REGION_REAL | \
					 VMM_REGION_VIRTUAL | \
					 VMM_REGION_ALIAS | \
					 VMM_REGION_PHYSALIAS)
